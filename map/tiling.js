...
function canvasResize() {
	...
	if(typeof mapCnv != "undefined") {
		width=mapCnv.width=boxCnv.width=pinCnv.width=trpCnv.width=uiCnv.width=canvas.width=getWidth();
		height=mapCnv.height=boxCnv.height=pinCnv.height=trpCnv.height=uiCnv.height=canvas.height=getHeight();
		mapCtx.imageSmoothingEnabled=false;
		boxCtx.imageSmoothingEnabled=false;
		pinCtx.imageSmoothingEnabled=false;
		trpCtx.imageSmoothingEnabled=false;
